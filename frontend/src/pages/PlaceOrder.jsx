  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Email name' type="email" />
        <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Street name' type="text" />
        <div className='flex gap-3'>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder="Zipcod" type="number" />
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='State' type="text" />
        </div>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=>setMethod("cod")} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <p className='text-gray-500 text-sm font-medium mx-4'>CASH ON DELIVERY NOW</p>
            </div>
          </div>
